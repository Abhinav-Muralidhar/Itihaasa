    ...
    Row(modifier = Modifier.fillMaxWidth()) {
        Column(horizontalAlignment = Alignment.CenterHorizontally) {
            ...
            Box(
                ...
                if (explored) {
                    Icon(Icons.Default.Check, contentDescription = null, tint = Parchment, modifier = Modifier.size(14.dp))
                }
            }
            Canvas(
                modifier = Modifier
        ...
        Surface(
            ...
            Column(
                ...
                Text(
                    ...
                    fontSize = 12.sp,
                    color = if (explored) HeritageOchre else Charcoal.copy(alpha = 0.7f)
                )
            }
        }
    }
